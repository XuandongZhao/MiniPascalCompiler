...
typedef enum {
    T_eq, T_ne, T_lt, T_gt, T_le,
    T_ge, T_ult, T_ule, T_ugt, T_uge
} T_relOp;
typedef enum {
...
struct T_exp_ {
    enum {
        T_BINOP, T_MEM, T_TEMP, T_ESEQ, T_NAME, T_CONST, T_CALL
    } exp_type;
    union {
        struct {
            T_binOp op;
...
T_relOp T_Oppo_Rel(T_relOp);
T_relOp T_Swap_Rel(T_relOp);
#endif
